...
CREATE TABLE PROFISSIONAL_TEM_ESPECIALIDADE (
...
insert into PROFISSIONAL (IDPROFISSIONAL, NOME) values (1,'Leandro');
insert into PROFISSIONAL (IDPROFISSIONAL, NOME) values (2,'Gabriel');

insert into cliente (IDCLIENTE, NOME,SOBRENOME,TELEFONE,OBSERVACAO) values (1,'Fernanda','Cristina','48999999999', 'cliente que gosta de ser atendido por fulano');
insert into cliente (IDCLIENTE, NOME,SOBRENOME,TELEFONE,OBSERVACAO) values (2,'MARIA','Carmo ','48888888888 ','CHATA');
